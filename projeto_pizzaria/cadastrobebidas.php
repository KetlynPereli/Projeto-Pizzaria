    ...
    <div class="fundo_bebida">
        <div class="form">
            <fieldset class="novo">
                ...
                <form action="crudbebida.php" method="POST" class="formulario">
                    <label for="bebidas">Código da Bebida:</label><br>
                    <input type="text" id="bebidas" name="bebidas" required><br>
