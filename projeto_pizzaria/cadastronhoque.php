...
<body>
    ...
    <div class="fundo_nhoque">
        <div class="form">
            <fieldset class="novo">
                <legend>Nhoques</legend>
                <form action="crudnhoque.php" method="POST" class="formulario">
                    <label for="nhoque">Código de Nhoque:</label>
                    <input type="text" id="nhoque" name="nhoque" required><br>
                    <label for="nhoques">Nome do Nhoque:</label><br>
                    <select name="nhoques">
