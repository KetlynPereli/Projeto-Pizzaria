...
<div id="logo"></div>
    ...
    <div class="form">
        <fieldset class="novo">
            ...
            <form action="crudsobremesa.php" method="POST" class="formulario">
                <label for="sobremesas">Código da Sobremesa:</label>
                <input type="text" id="sobremesas" name="sobremesas" required><br>
