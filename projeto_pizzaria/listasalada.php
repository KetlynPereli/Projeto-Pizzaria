...
<body>
    ...
    <div class="fundo_salada">
        <div class="form">
            <form action="excluirsalada.php" method="post">
                <center>
                    <h1>Saladas Cadastradas</h1>
                    <table id="tabela" border="1">
                        <thead>
                            <th>Código da Salada</th>
                            <th>Nome da Salada</th>
                            <th>Valor</th>
                        ...
                        $dados = mysqli_query($conexao, "SELECT * FROM `salada`");
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= @$item['salada'] ?></td>
                                <td><?= @$item['valor_salada'] ?></td>
                                <td><a href="editarsalada'.php?id_salada<?php echo @$item['id_salada']; ?>"><i class="fa fa-pencil"></a></td>
                                <td onClick="verifica('<?= @$item["id_salada"]; ?>')"><a href="#"><i class="fa fa-trash"></a></td>
                            </tr>
                    ...
                    <script>
                        function verifica(recid) {
                            if (confirm("Tem certeza que deseja Excluir permanentemente esta Salada'")) {
                                window.location = "excluirsalada.php?id_salada'" + recid
                            }
                        }
                    </script>
