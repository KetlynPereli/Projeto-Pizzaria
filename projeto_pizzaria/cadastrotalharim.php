...
<head>
    ...
    <title>Cadastro de Talharim</title>
</head>
...
<body>
    ...
    <div class="fundo_talharim">
        <div class="form">
            <fieldset class="novo">
                <legend>Talharim ou Rondlei</legend>
                <form action="crudtalharim.php" method="POST" class="formulario">
                    <label for="talharim">Código do Talharim ou Rondlei:</label>
                    <input type="text" id="talharim" name="talharim" required><br>
