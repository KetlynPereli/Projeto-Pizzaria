...
<head>
    ...
    <title>Cadastro de Sanduiche</title>
</head>
    ...
    <div class="fundo_sanduiche">
        <div class="form">
            <fieldset class="novo">
                ...
                <form action="crudsanduiche.php" method="POST" class="formulario">
                    <label for="sanduiche">Código do Sanduiche:</label>
                    <input type="text" id="sanduiche" name="sanduiche" required><br>
